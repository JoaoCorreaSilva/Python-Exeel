...
class Aplicacao():
    ...
    def botoes(self):
        ...
        self.btDimensao = Button(self.frame_3, text="Tela", command=self.monitor)
        self.btDimensao.place(relx=0.15, rely=0.15, relwidth=0.1, relheight=0.1)

        self.btposicao = Button(self.frame_3, text="Posição", command=self.posicao)
        self.btposicao.place(relx=0.25, rely=0.15, relwidth=0.1, relheight=0.1)

        self.btmover = Button(self.frame_3, text="Mover mouse", command=self.move_mouse)
        self.btmover.place(relx=0.35, rely=0.15, relwidth=0.1, relheight=0.1)

        self.btcaptura = Button(self.frame_3, text="Captura")
        self.btcaptura.place(relx=0.45, rely=0.15, relwidth=0.1, relheight=0.1)

        self.btboot = Button(self.frame_3, text="Boot", command=self.bot)
        self.btboot.place(relx=0.55, rely=0.15, relwidth=0.1, relheight=0.1)
